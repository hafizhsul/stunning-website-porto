...
- `src/pages/Landing.tsx` — the full one-file portfolio: navbar (scroll-spy, theme toggle, mobile menu), hero with animated code card, tech marquee, filterable projects grid, about, experience timeline, skills, contact, footer.
- `src/pages/NotFound.tsx` — 404 page.
- `src/data/content.ts` — all content and i18n strings (EN/ID); projects, experience, skills, facts, socials. The portfolio is data-driven — edit here to change content.
